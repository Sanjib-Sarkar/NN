...
taj_lat = df.lat[12800: 12825]
taj_lng = df.lng[12800: 12825]
...
test = ts_from_array(train, None, window=window_size, batch=1, shuffle=False)
...
for i in range(next):
    ...
    # coordinates = np.reshape(coordinates, (1, coordinates.shape[0], coordinates.shape[1]))
